    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Chứng chỉ bồi dưỡng</h3>
            </div>
        </div>
        <!-- End Page Header -->
        <!-- Default Light Table -->
                        ...
                        <table class="table mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Mã chứng chỉ</th>
                                    <th scope="col" class="border-0">Tên chứng chỉ</th>
                                ...
                                <tr class="add add-hidden">
                                    <form action="{{ url('chungchiBD') }}" method="POST">
                                        @csrf
                                        <td>Thêm</td>
                                        <td><input type="text" name="MA_CC_BD"></td>
                                        <td><input type="text" name="TEN_CC_BD"></td>
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr class="bdy">
                                        ...
                                        <form action="{{ url('chungchiBD/update') }}" name="fUpdate" method="POST">
                                            @method('put')
                                            @csrf
                                            <td>
                                                <input type="text" class="inline-update none-update" name="MA_CC_BD"
                                                    value="{{ $item->MA_CHUNG_CHI_BD }}" readonly>
                                            </td>
                                            <td>
                                                <input type="text" class="inline-update" name="TEN_CC_BD"
                                                    value="{{ $item->TEN_CHUNG_CHI_BD }}" readonly>
                                            </td>
                                            <td>
                                            ...
                                            <div class="dropdown open">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="triggerId" style="left:-2rem">
                                                    ...
                                                    <button class="dropdown-item "><a
                                                            href="{{ url('chungchiBD/destroy') . '/' . $item->MA_CHUNG_CHI_BD }}"
