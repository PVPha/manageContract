    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Hình thức bồi dưỡng</h3>
            </div>
        </div>
        <!-- End Page Header -->
        <!-- Default Light Table -->
                        ...
                        <table class="table mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Mã hình thức </th>
                                    <th scope="col" class="border-0">Tên hình thức </th>
                                    <th scope="col" class="border-0">Từ viết tắt</th>
                                    <th scope="col" class="border-0">Hành động</th>
                                </tr>
                                <tr class="add add-hidden">
                                    <form action="{{ url('hinhthucBD') }}" method="POST">
                                        @csrf
                                        <td>Thêm</td>
                                        <td><input type="text" name="MA_HTBD"></td>
                                        <td><input type="text" name="TEN_HTBD"></td>
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr class="bdy">
                                        ...
                                        <form action="{{ url('hinhthucBD/update') }}" name="fUpdate" method="POST">
                                            @method('put')
                                            @csrf
                                            <td>
                                                <input type="text" class="inline-update none-update" name="MA_HTBD"
                                                    value="{{ $item->MA_HINH_THUC_BD }}" readonly>
                                            </td>
                                            <td>
                                                <input type="text" class="inline-update" name="TEN_HTBD"
                                                    value="{{ $item->TEN_HINH_THUC_BD }}" readonly>
                                            </td>
                                            <td>
                                            ...
                                            <div class="dropdown open">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="triggerId" style="left:-2rem">
                                                    ...
                                                    <button class="dropdown-item "><a
                                                            href="{{ url('hinhthucBD/destroy') . '/' . $item->MA_HINH_THUC_BD }}"
