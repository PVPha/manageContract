    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Kỷ luật</h3>
            </div>
        </div>
        <!-- End Page Header -->
        <!-- Default Light Table -->
                        ...
                        <table class="table mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Mã kỷ luật</th>
                                    <th scope="col" class="border-0">Tên kỷ luật</th>
                                ...
                                <tr class="add add-hidden">
                                    <form action="{{ url('kyluat') }}" method="POST">
                                        @csrf
                                        <td>Thêm</td>
                                        <td><input type="text" name="MA_KL"></td>
                                        <td><input type="text" name="TEN_KL"></td>
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr class="bdy">
                                        ...
                                        <form action="{{ url('kyluat/update') }}" name="fUpdate" method="POST">
                                            @method('put')
                                            @csrf
                                            <td>
                                                <input type="text" class="inline-update none-update" name="MA_KL"
                                                    value="{{ $item->MA_KY_LUAT }}" readonly>
                                            </td>
                                            <td>
                                                <input type="text" class="inline-update" name="TEN_KL"
                                                    value="{{ $item->TEN_KY_LUAT }}" readonly>
                                            </td>
                                            <td>
                                            ...
                                            <div class="dropdown open">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="triggerId" style="left:-2rem">
                                                    ...
                                                    <button class="dropdown-item "><a
                                                            href="{{ url('kyluat/destroy') . '/' . $item->MA_KY_LUAT }}"
