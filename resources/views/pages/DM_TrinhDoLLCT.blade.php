    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Trình độ LLCT</h3>
            </div>
        </div>
        <!-- End Page Header -->
        <!-- Default Light Table -->
                        ...
                        <table class="table mb-0">
                            <thead class="bg-light">
                                ...
                                <tr class="add add-hidden">
                                    <form action="{{ url('trinhdoLLCT') }}" method="POST">
                                        @csrf
                                        <td>Thêm</td>
                                        <td><input type="text" name="MA_TD_LLCT"></td>
                                        <td><input type="text" name="TEN_TD_LLCT"></td>
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr class="bdy">
                                        ...
                                        <form action="{{ url('trinhdoLLCT/update') }}" name="fUpdate" method="POST">
                                            @method('put')
                                            @csrf
                                            <td>
                                                <input type="text" class="inline-update none-update" name="MA_TD_LLCT"
                                                    value="{{ $item->MA_TRINH_DO_LLCT }}" readonly>
                                            </td>
                                            <td>
                                                <input type="text" class="inline-update" name="TEN_TD_LLCT"
                                                    value="{{ $item->TEN_TRINH_DO_LLCT }}" readonly>
                                            </td>
                                            <td>
                                            ...
                                            <div class="dropdown open">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="triggerId" style="left:-2rem">
                                                    ...
                                                    <button class="dropdown-item "><a
                                                            href="{{ url('trinhdoLLCT/destroy') . '/' . $item->MA_TRINH_DO_LLCT }}"
