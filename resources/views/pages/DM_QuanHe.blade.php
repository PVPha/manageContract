    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Quan hệ</h3>
            </div>
        </div>
        <!-- End Page Header -->
        <!-- Default Light Table -->
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr class="bdy">
                                        ...
                                        <form action="{{ url('quanhe/update') }}" name="fUpdate" method="POST">
                                            @method('put')
                                            @csrf
                                            <td>
                                                <input type="text" class="inline-update none-update" name="MA_QH"
                                                    value="{{ $item->MA_QUAN_HE }}" readonly>
                                            </td>
                                            <td>
                                                <input type="text" class="inline-update" name="TEN_QH"
                                                    value="{{ $item->TEN_QUAN_HE }}" readonly>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" class="inline-update" name="QH_VC"
                                                    value="{{ $item->QHE_VO_CHONG }}" readonly>
                                            </td>
                                        </form>
                                        <td>
                                            ...
                                            <div class="dropdown open">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="triggerId" style="left:-2rem">
                                                    ...
                                                    <button class="dropdown-item "><a
                                                            href="{{ url('quanhe/destroy') . '/' . $item->MA_QUAN_HE }}"
