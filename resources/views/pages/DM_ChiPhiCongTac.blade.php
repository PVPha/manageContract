    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Chi phí công tác</h3>
            </div>
        </div>
        <!-- End Page Header -->
        <!-- Default Light Table -->
                        ...
                        <table class="table mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Mã chi phí</th>
                                    <th scope="col" class="border-0">Tên chi phí</th>
                                    <th scope="col" class="border-0">Từ viết tắt</th>
                                    <th scope="col" class="border-0">Hành động</th>
                                </tr>
                                <tr class="add add-hidden">
                                    <form action="{{ url('chiphiCT') }}" method="POST">
                                        @csrf
                                        <td>Thêm</td>
                                        <td><input type="text" name="MA_CP_CT"></td>
                                        <td><input type="text" name="TEN_CP_CT"></td>
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr class="bdy">
                                        ...
                                        <form action="{{ url('chiphiCT/update') }}" name="fUpdate" method="POST">
                                            @method('put')
                                            @csrf
                                            <td>
                                                <input type="text" class="inline-update none-update" name="MA_CP_CT"
                                                    value="{{ $item->MA_CPHI_CONG_TAC }}" readonly>
                                            </td>
                                            <td>
                                                <input type="text" class="inline-update" name="TEN_CP_CT"
                                                    value="{{ $item->TEN_CPHI_CONG_TAC }}" readonly>
                                            </td>
                                            <td>
                                            ...
                                            <div class="dropdown open">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="triggerId" style="left:-2rem">
                                                    ...
                                                    <button class="dropdown-item "><a
                                                            href="{{ url('chiphiCT/destroy') . '/' . $item->MA_CPHI_CONG_TAC }}"
