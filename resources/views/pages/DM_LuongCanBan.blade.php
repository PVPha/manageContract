    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Lương căn bản</h3>
            </div>
        </div>
        <!-- End Page Header -->
        <!-- Default Light Table -->
                        ...
                        <table class="table mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Ngày bắt đầu hiệu lực</th>
                                    <th scope="col" class="border-0">Ngày hết hiệu lực</th>
                                    <th scope="col" class="border-0">Lương cơ bản</th>
                                    <th scope="col" class="border-0">Hành động</th>
                                </tr>
                                <tr class="add add-hidden">
                                    <form action="{{ url('luongCB') }}" method="POST">
                                        @csrf
                                        <td>Thêm</td>
                                        <td><input type="date" name="NGAY_BD"></td>
                                        <td><input type="date" name="NGAY_KT"></td>
                                        <td><input type="text" name="LUONG_CB"></td>
                                        <td>
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr class="bdy">
                                        ...
                                        <form action="{{ url('luongCB/update') }}" name="fUpdate" method="POST">
                                            @method('put')
                                            @csrf
                                            <td>
                                                <input type="date" class="inline-update none-update" name="NGAY_BD"
                                                    value="{{ $item->NGAY_BAT_DAU_HIEU_LUC }}" readonly>
                                            </td>
                                            <td>
                                                <input type="date" class="inline-update" name="NGAY_KT"
                                                    value="{{ $item->NGAY_HET_HIEU_LUC }}" readonly>
                                            </td>
                                            <td>
                                                <input type="text" class="inline-update" name="LUONG_CB"
                                                    value="{{ $item->LUONG_CO_BAN }}" readonly>
                                            </td>
                                        </form>
                                        <td>
                                            ...
                                            <div class="dropdown open">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="triggerId" style="left:-2rem">
                                                    ...
                                                    <button class="dropdown-item "><a
                                                            href="{{ url('luongCB/destroy') . '/' . $item->LUONG_CO_BAN }}"
