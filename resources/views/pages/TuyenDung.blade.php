                        ...
                        <table class="table mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Mã tuyển dụng</th>
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr class="bdy">
                                        ...
                                        <form action="{{ 'tuyendung/update' }}" name="fUpdate" method="POST">
                                            @method('put')
                                            @csrf
                                            <td>
                                                <input type="text" class="inline-update none-update" name="MA_TD"
                                                    value="{{ $item->MA_TD }}" style="width: 8.5rem" readonly>
                                            </td>
                                            <td>
                                                <input type="text" class="inline-update" name="BO_MON"
                                                    value="{{ $item->BO_MON }}" style="width: 8.5rem" readonly>
                                            </td>
                                            <td>
                                                <input type="text" class="inline-update none-update" name="KHOA"
                                                    value="{{ $item->KHOA }}" style="width: 8.5rem" readonly>
                                            </td>
                                            <td>
                                                <input type="text" class="inline-update" name="SO_LUONG"
                                                    value="{{ $item->SO_LUONG }}" style="width: 8.5rem" readonly>
                                            </td>
                                            <td>
                                                <input type="date" class="inline-update" name="NGAY_BD"
                                                    value="{{ $item->NGAY_BD }}" style="width: 8.5rem" readonly>
                                            </td>
                                            <td>
                                                <input type="date" class="inline-update" name="NGAY_KT"
                                                    value="{{ $item->NGAY_KT }}" style="width: 8.5rem" readonly>
                                            </td>
                                        </form>
                                        <td>
                                            ...
                                            <div class="dropdown open">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="triggerId" style="left:-2rem">
                                                    ...
                                                    <button class="dropdown-item "><a
                                                            href="{{ url('tuyendung/destroy') . '/' . $item->MA_TD }}"
