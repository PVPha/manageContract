                        ...
                        <table class="table mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Tên tỉnh-TP</th>
                                    <th scope="col" class="border-0">Từ viết tắt</th>
                                    <th scope="col" class="border-0">Mã quốc gia</th>
                                    <th scope="col" class="border-0">Hành động</th>
                                </tr>
                                <tr class="add add-hidden">
                                    <form action="{{ url('tinhTP') }}" method="POST">
                                        @csrf
                                        <td>Thêm</td>
                                        <td><input type="text" name="MA_TTP"></td>
                                        <td><input type="text" name="TEN_TTP"></td>
                                        <td><input type="text" name="TU_VT"></td>
                                        <td><input type="text" name="MA_QG"></td>
                                        <td>
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr class="bdy">
                                        ...
                                        <form action="{{ url('tinhTP/update') }}" name="fUpdate" method="POST">
                                            @method('put')
                                            @csrf
                                            <td>
                                                <input type="text" class="inline-update none-update" name="MA_TTP"
                                                    value="{{ $item->MA_TINH_TP }}" readonly>
                                            </td>
                                            <td>
                                                <input type="text" class="inline-update" name="TEN_TTP"
                                                    value="{{ $item->TEN_TINH_TP }}" readonly>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" class="inline-update" name="MA_QG"
                                                    value="{{ $item->FK_MA_QUOC_GIA }}" readonly>
                                            </td>
                                        </form>
                                        <td>
                                            ...
                                            <div class="dropdown open">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="triggerId" style="left:-2rem">
                                                    ...
                                                    <button class="dropdown-item "><a
                                                            href="{{ url('tinhTP/destroy') . '/' . $item->MA_TINH_TP }}"
